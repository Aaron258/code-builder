package org.mybatis.generator.plugins.dao;
...
public class MapperPlugin extends PluginAdapter {
    ...
    private static final String DEFAULT_DAO_SUPER_CLASS = "com.hzcf.insurancesale.dao.BaseMapper";
    private static final String DEFAULT_EXPAND_DAO_SUPER_CLASS = "com.hzcf.insurancesale.dao.BaseExpandMapper";
    ...
    public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles(IntrospectedTable introspectedTable) {
        ...
        for (GeneratedJavaFile javaFile : introspectedTable.getGeneratedJavaFiles()) {
            ...
            if (shortName.endsWith("Mapper")) { // 扩展Mapper
                ...
                mapperInterface.setVisibility(JavaVisibility.PUBLIC);
                mapperInterface.addStaticImport(daoSuperClass);
                mapperInterface.addStaticImport(daoSuperClass);
                mapperInterface.addJavaDocLine("/**");
                mapperInterface.addJavaDocLine(" * " +shortName+"Mapper");
                mapperInterface.addJavaDocLine(" * @author Aaron");
                mapperInterface.addJavaDocLine(" */");
