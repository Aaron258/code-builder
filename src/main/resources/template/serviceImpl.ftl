...
import ${prefixPackageName}.bean.${domainObjectName}Example;
import ${prefixPackageName}.bean.${domainObjectName}Example.Criteria;
import ${prefixPackageName}.dao.${domainObjectName}Mapper;
